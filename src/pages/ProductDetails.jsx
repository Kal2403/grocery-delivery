        ...
        <div className="mt-12">
            ...
            <div className='flex flex-col items-center mt-20'>
                <div className='flex flex-col items-center w-max'>
                    <p className='text-3xl font-medium'>Realted Products</p>
                ...
                <button onClick={() => {navigate("/products"); scrollTo(0, 0)}} className='mt-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-primary hover:bg-primary/10 transition'>See More</button>
            </div>
        </div>
    );
};
